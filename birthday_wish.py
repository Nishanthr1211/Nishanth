...
GMAIL_ID = 'nithish231098@gmail.com'
GMAIL_PWD = 'Nithish@23'
...
if __name__=="__main__":
	...
	dataframe = pd.read_excel("12.xlsx")
	...
	for index,item in dataframe.iterrows():
		...
		# sheet as : DD-MM
		#bday = item['Birthday'].strftime("%d-%m") if pd.notna(item['Birthday']) else None
